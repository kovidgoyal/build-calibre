...
python_deps = (
    ...
    ' pygments pycrypto apsw lxml html5-parser pillow netifaces psutil dbuspython macfsevents'
    ' webencodings html5lib feedparser markdown html2text soupsieve beautifulsoup4'
).strip().split()
